...
// Single source -> every harness
const fileLinks = [
  { src: ".ai/agents.md", dest: "AGENTS.md" },
  { src: ".ai/agents.md", dest: "CLAUDE.md" },
  { src: ".ai/agents.md", dest: "GEMINI.md" },
  { src: ".ai/agents.md", dest: ".github/copilot-instructions.md" },
...
function syncAsset(src, dest) {
  ...
  try {
    ...
    if (err.code === "EPERM" || err.code === "EACCES" || err.code === "EINVAL") {
      ...
      if (dest.endsWith(".md")) {
        const header = `<!-- AUTO-GENERATED by .ai/sync.js — edit the source at ${src} instead -->\n`;
